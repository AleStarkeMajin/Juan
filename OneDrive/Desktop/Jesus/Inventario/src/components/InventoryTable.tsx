                  ...
                  <TableRow key={ingredient.id} className="hover:bg-zinc-50/50">
                    ...
                    <TableCell className="text-center">
                      <span className={isLow ? 'text-red-600 font-bold' : 'text-zinc-700'}>
                        {ingredient.currentQuantity} <span className="text-[10px] opacity-70">{ingredient.unit}</span>
                      </span>
                    </TableCell>
                    ...
                    <TableCell className="text-zinc-700 py-3 px-2 md:p-4">
                      <div className="flex flex-col">
                        ...
                        <span className="text-[9px] md:text-[10px] text-zinc-400">p/ {ingredient.purchaseQuantity} {ingredient.unit}</span>
                      </div>
                    </TableCell>
